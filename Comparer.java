...
public class invertDriver {
	...
	public static class sMap extends Mapper<Object, Text, Comparer, IntWritable>{
		...
		public void map(Object line_offset, Text line, Context outputContext) throws IOException, InterruptedException {
			...
			while(tokenizer.hasMoreTokens()) {
				...
				outputContext.getCounter(COUNTERS.WordCount).increment(1);
	...
	public static class sReduce extends Reducer<Comparer, IntWritable , Text, IntWritable>{
		@Override
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		System.out.println(counters.findCounter(COUNTERS.WordCount).getDisplayName() + ": " + counters.findCounter(COUNTERS.WordCount).getValue());
		System.out.println(counters.findCounter(COUNTERS.MapCount).getDisplayName() + ": " + counters.findCounter(COUNTERS.MapCount).getValue());
		...
		boolean check = FileUtil.copyMerge(gsfs, srcPath, gsfs, desPath, false, conf, null);
		if(check)
